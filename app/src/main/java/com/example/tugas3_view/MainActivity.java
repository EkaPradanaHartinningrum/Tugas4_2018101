    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(savedInstanceState == null){
            ...
            getSupportFragmentManager().beginTransaction().replace(R.id.fragment_container,
                    new presiden_fragment()).commit();
            navigationView.setCheckedItem(R.id.nav_presiden);}
    }
    ...
    public boolean onNavigationItemSelected(@NonNull MenuItem
        ...
        switch (item.getItemId()){
            ...
            case R.id.nav_provinsi:
                ...
                getSupportFragmentManager().beginTransaction().replace(R.id.fragment_container,
                        new provinsi_fragment()).commit();
                break;
            case R.id.nav_bantuan:

                getSupportFragmentManager().beginTransaction().replace(R.id.fragment_container,
                        new bantuan_fragment()).commit();
                break;
        }
